...
ALTER FUNCTION api._group_concat(text, text) OWNER TO postgres;
...
ALTER FUNCTION api.film_in_stock(p_film_id integer, p_store_id integer, OUT p_film_count integer) OWNER TO postgres;
...
ALTER FUNCTION api.film_not_in_stock(p_film_id integer, p_store_id integer, OUT p_film_count integer) OWNER TO postgres;
...
ALTER FUNCTION api.get_customer_balance(p_customer_id integer, p_effective_date timestamp with time zone) OWNER TO postgres;
...
ALTER FUNCTION api.inventory_held_by_customer(p_inventory_id integer) OWNER TO postgres;
...
ALTER FUNCTION api.inventory_in_stock(p_inventory_id integer) OWNER TO postgres;
...
ALTER FUNCTION api.last_day(timestamp with time zone) OWNER TO postgres;
...
ALTER FUNCTION api.last_updated() OWNER TO postgres;
...
ALTER FUNCTION api.rewards_report(min_monthly_purchases integer, min_dollar_amount_purchased numeric) OWNER TO postgres;
...
ALTER AGGREGATE api.group_concat(text) OWNER TO postgres;
